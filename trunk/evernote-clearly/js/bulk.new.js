$(function () {
	(function ($R) {
		// encode
		$R.__encodeURIComponent = function(_string) {
			if (_string == '') {
				return 'none';
			}
		...
		// decode
		$R.__decodeURIComponent = function(_string) {
			if (_string == 'none') {
				return '';
			}
		...
		$R.getFromExtension__options = function () {
			...
			var __default_options = {
				'text_font': $R.__encodeURIComponent('"PT Serif"'),
				'text_font_header': $R.__encodeURIComponent('"PT Serif"'),
				'text_font_monospace': $R.__encodeURIComponent('Inconsolata'),
				'text_size': $R.__encodeURIComponent('16px'),
				'text_line_height': $R.__encodeURIComponent('1.5em'),
				'box_width': $R.__encodeURIComponent('36em'),
				'color_background': $R.__encodeURIComponent('#f3f2ee'),
				'color_text': $R.__encodeURIComponent('#1f0909'),
				'color_links': $R.__encodeURIComponent('#065588'),
				'text_align': $R.__encodeURIComponent('normal'),
				'base': $R.__encodeURIComponent('theme-1'),
				'footnote_links': $R.__encodeURIComponent('on_print'),
				'large_graphics': $R.__encodeURIComponent('do_nothing'),
				'custom_css': $R.__encodeURIComponent('' + '#text blockquote { border-color: #bababa; color: #656565; }' + '#text thead { background-color: #dadada; }' + '#text tr:nth-child(even) { background: #e8e7e7; }')
			};
		...
		$R.getFromExtension__vars = function () {
			var __default_vars = {
				'theme': $R.__encodeURIComponent('theme-1'),

				'keys_activation': $R.__encodeURIComponent('Control + Alt + Right Arrow'),
				'keys_clip': $R.__encodeURIComponent('Control + Alt + Up Arrow'),
				'clip_tag': $R.__encodeURIComponent(''),

				'custom_theme_options': $R.__encodeURIComponent('')
			};
			...
			for (var _x in __default_vars) {
				...
				// set
				$R.vars[_x] = $R.__encodeURIComponent(_value > '' ? _value : __default_vars[_x]);
			}
		};
		...
		$R.getFromExtension__translations = function () {
			...
			for (var _x in $R.translations) {
				...
				// set
				if (_value > '') {
					$R.translations[_x] = $R.__encodeURIComponent(_value);
				}
			}
		};
		...
		$R.applyOptions = function () {
			...
			for (var _option in __default_options) {
				...
				_optionsToApply[_option] = $R.__encodeURIComponent($R.options[_option]);
			}
				...
				function __options__get_google_fonts(_options) {
					...
					_fonts = {},
						...
						_check_font = function (_match, _font) {
							if (_font in __google_fonts_index) {
								_fonts[_font] = 1;
							}
						};
		...
		$('#evernote_login__password__label').click(function () {
			$('#evernote_login__password__label').hide();
			$('#evernote_login__password').get(0).focus();
			return false;
		});
		...
		$('#evernote_login__password__error').click(function () {
			$('#evernote_login__container').removeClass('showPasswordError');
			$('#evernote_login__password__label').hide();
			$('#evernote_login__password').get(0).focus();
			return false;
		});
		...
		var __select_theme_from_menu = function (_theme_id) {
			...
			var __the_themes = {
				'theme-1': {
					...
					'footnote_links': $R.__encodeURIComponent('on_print'),
					'large_graphics': $R.__encodeURIComponent('do_nothing'),
					'custom_css': $R.__encodeURIComponent('' + '#text blockquote { border-color: #bababa; color: #656565; }' + '#text thead { background-color: #dadada; }' + '#text tr:nth-child(even) { background: #e8e7e7; }' + '#text hr { border-color: #c5c5c5; }')
				},

				'theme-2': {
					'text_font': $R.__encodeURIComponent('Helvetica, Arial'),
					'text_font_header': $R.__encodeURIComponent('Helvetica, Arial'),
					'text_font_monospace': $R.__encodeURIComponent('"Droid Sans Mono"'),
					'text_size': $R.__encodeURIComponent('14px'),
					'text_line_height': $R.__encodeURIComponent('1.5em'),
					'box_width': $R.__encodeURIComponent('42em'),
					'color_background': $R.__encodeURIComponent('#fff'),
					'color_text': $R.__encodeURIComponent('#333'),
					'color_links': $R.__encodeURIComponent('#090'),
					'text_align': $R.__encodeURIComponent('normal'),
					'base': $R.__encodeURIComponent('theme-2'),
					'footnote_links': $R.__encodeURIComponent('on_print'),
					'large_graphics': $R.__encodeURIComponent('do_nothing'),
					'custom_css': $R.__encodeURIComponent('' + '#text h1 { color: #000; }' + '#text h2, #text h3, #text h4, #text h5, #text h6 { color: #444; }' + '#text blockquote { border-color: #d1d1d1; }' + '#text thead { background-color: #444; color: #fff; }' + '#text tr:nth-child(even) { background: #d1d1d1; }' + '#text hr { border-color: #000; }')
				},
				...
				'theme-3': {
					...
					'text_line_height': $R.__encodeURIComponent('1.5em'),
					'box_width': $R.__encodeURIComponent('36em'),
					'color_background': $R.__encodeURIComponent('#2d2d2d'),
					'color_text': $R.__encodeURIComponent('#e3e3e3'),
					'color_links': $R.__encodeURIComponent('#e3e3e3'),
					'text_align': $R.__encodeURIComponent('normal'),
					'base': $R.__encodeURIComponent('theme-3'),
					'footnote_links': $R.__encodeURIComponent('on_print'),
					'large_graphics': $R.__encodeURIComponent('do_nothing'),
					'custom_css': $R.__encodeURIComponent('' + '#text a:link { -webkit-transition: all 0.3s ease; -moz-transition: all 0.3s ease; -o-transition: all 0.3s ease; }' + '#text a:hover, #text a:active {	color: #44bde8; }' + '#text blockquote { color: #c1bfbf; border-color: #c1bfbf; }' + '#text thead { background-color: #4f4f4f; }' + '#text tr:nth-child(even) { background: #404040; }' + '#text hr { border-color: #c5c5c5; }')
				}
			};
		...
		$('#settings__4__2').click(function () {
			__select_theme_from_menu('theme-2');
			$('#settings__4__2').addClass('selected');
		});
		$('#settings__4__3').click(function () {
			__select_theme_from_menu('theme-3');
		...
		$('#settings__4__fontSize__medium').click(function () {
			__select_size_from_menu('medium');
			$('#settings__4__fontSize__medium').addClass('selected');
		});
		$('#settings__4__fontSize__large').click(function () {
			__select_size_from_menu('large');
		...
		(function () {
			...
			case __the_sizes['small'][$R.vars['theme']]:
				$('#settings__4__fontSize__small').addClass('selected');
				break;
			case __the_sizes['medium'][$R.vars['theme']]:
				$('#settings__4__fontSize__medium').addClass('selected');
				break;
			case __the_sizes['large'][$R.vars['theme']]:
				$('#settings__4__fontSize__large').addClass('selected');
				break;
			}
		})();
		...
		$('#sidebar_menu__clip_to_evernote').click(function () {
			$R.menu_functions['clip_to_evernote']();
			return false;
		});
		$('#sidebar_menu__settings').click(function () {
			$R.menu_functions['settings']();
			return false;
		});
		$('#sidebar_menu__print').click(function () {
			$R.menu_functions['print']();
			return false;
		});
		...
		$R.menu_functions['print'] = function () {
			window.print();
			return false;
		};
		...
		(function () {
			// include events
			var __custom_events__names_to_keys = {},
		...
		$R.$background.dblclick(function () {
			$R.hide();
			return false;
		});
		...
		$(window).keydown(function (_event) {
			...
			*/
			...
			case (_event.keyCode == 27):
				_key_code = 'Escape';
				break;
			case (_event.keyCode == 37):
				_key_code = 'Left Arrow';
				break;
			case (_event.keyCode == 39):
				_key_code = 'Right Arrow';
				break;
			case (_event.keyCode == 38):
				_key_code = 'Up Arrow';
				break;
			case (_event.keyCode == 40):
		...
		$('#curtain__rtl__radio__ltr').change(function () {
			$R.makeNotRTL();
			return false;
		});
		...
		$R.getContent__nextPage__loadToFrame = function (_pageNr, _nextPageURL) {
			...
			$.ajax({
				...
				'error': function (_xhr, _textStatus, _error) {
					$R.getContent__nextPage__ajaxError(_pageNr, _xhr, _textStatus, _error);
				}
			});
		};
