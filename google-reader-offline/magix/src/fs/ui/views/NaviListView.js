    ...
    fs.ui.views.NaviListView = function(p_container)
    {
        ...
        var naviMap = [
           {
               ...
               [
                    {id: "all", icon: "folders" },
                    {id: "unreads", icon: "folder_unread" },
                    {id: "favourites", icon: "folder_fav" },
                    {id: "today", icon: "folder_time" },
                    {id: "24hours", icon: "folder_time" }
               ]
           },
        ...
        me.selectItem = function(p_id, p_callback, p_errorCallback)
        {
            ...
            if (item != null)
            {
                ...
                {
                    var args = { selectingPath: p_id, cancel: false };
                    ...
                    args = { lastSelectedPath: me.selectedPath };
        ...
        function _loadSubscriptions()
        {
            ...
            if (me.selectedPath != null)
            {
                ...
                me.selectedItem = null;
                me.selectedPath = null;
                me.selectItem(path, null, function() { me.selectItem("favourites"); });
            }
        }
        ...
        var _dragList = null;
        var _dragging = false, _dragItem = null, _dragItemClass = null, _dragIndicator = null, _dragIndex = -1;
        var _sensitivity = 4;
        ...
        function _ulSubscription_onmousemove()
        {
            ...
            else
            {
                ...
                if (Math.abs(_mouseX - event.x) >= _sensitivity || Math.abs(_mouseY - event.y) >= _sensitivity)
                {
                    ...
                    _dragItemClass = _dragItem.className; _dragItem.className = "";
                    _dragIndex = -1;
